  ...
  return (
    <div className="space-y-6 animate-slide-in">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                value={formData.ruangan_rs}
                onChange={(e) => setFormData({...formData, ruangan_rs: e.target.value})}
      ...
      <div className="grid grid-cols-2 gap-4">
        <Card 
          className="border-0 shadow-card bg-white cursor-pointer hover:shadow-card-hover transition-shadow"
